package com.didan.forum.posts.config.database;
...
@EnableJpaRepositories(
    ...
    basePackages = {"com.didan.forum.posts.repository.post"}
)
public class PostDatabaseConfig {

  @Primary
  @Bean
  @ConfigurationProperties("spring.datasource.postdb")
  ...
  @ConfigurationProperties(prefix = "spring.datasource.postdb.hiraki")
  ...
  public LocalContainerEntityManagerFactoryBean postEntityManagerFactory(
    ...
    return builder
        ...
        .packages("com.didan.forum.posts.entity.post")
  ...
  public PlatformTransactionManager postsTransactionManager(@Qualifier("postsEntityManagerFactory")
